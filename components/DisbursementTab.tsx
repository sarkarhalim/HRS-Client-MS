      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          <div className="relative flex-1 sm:w-80">
            <input 
              type="text" 
              placeholder="Deep search by Purpose, Date, Fund, Amount..." 
              value={searchQuery}
              onChange={(e) => {
        ...
        <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm">
            <div>
              ...
              <p className="text-[10px] text-slate-700 font-bold uppercase tracking-widest mt-2">Comprehensive financial audit trail</p>
            </div>
